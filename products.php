...
<html lang="en">
    <head>
        ...
        <title>Products | ECOMM Store</title>
    ...
    <body>
        ...
        <div class="container" id="content">
            ...
            <div class="jumbotron home-spacer" id="products-jumbotron">
                <h1>Welcome to our ECOMM Store!</h1>
                <p>We have the best Clothes, Watches and Kitchenware for you.</p>
            </div>
            <hr>
